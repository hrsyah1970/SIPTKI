...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--target-os=linux --enable-cross-compile --enable-runtime-cpudetect --disable-everything --disable-doc --disable-ffplay --disable-ffmpeg --disable-ffprobe --disable-ffserver --disable-avdevice --disable-avfilter --disable-avformat --disable-swresample --disable-network --enable-decoder=mjpeg --enable-encoder=mjpeg --enable-decoder=mpeg4 --enable-encoder=mpeg4 --enable-decoder=h264 --enable-decoder=h263p --enable-encoder=h263p --enable-decoder=h263 --enable-encoder=h263 --extra-cflags=-w --disable-static --enable-shared --disable-symver --build-suffix=-linphone-x86 --arch=x86 --sysroot=/usr/src/herman/eclipse/android-ndk-r10e/platforms/android-14/arch-x86 --cross-prefix=/usr/src/herman/eclipse/android-ndk-r10e/toolchains/x86-4.8/prebuilt/linux-x86/bin/i686-linux-android- --disable-mmx --disable-sse2 --disable-ssse3 --extra-cflags=-O3
prefix=/usr/local
...
ARCH=x86
CC=/usr/src/herman/eclipse/android-ndk-r10e/toolchains/x86-4.8/prebuilt/linux-x86/bin/i686-linux-android-gcc
CXX=/usr/src/herman/eclipse/android-ndk-r10e/toolchains/x86-4.8/prebuilt/linux-x86/bin/i686-linux-android-g++
AS=/usr/src/herman/eclipse/android-ndk-r10e/toolchains/x86-4.8/prebuilt/linux-x86/bin/i686-linux-android-gcc
LD=/usr/src/herman/eclipse/android-ndk-r10e/toolchains/x86-4.8/prebuilt/linux-x86/bin/i686-linux-android-gcc
DEPCC=/usr/src/herman/eclipse/android-ndk-r10e/toolchains/x86-4.8/prebuilt/linux-x86/bin/i686-linux-android-gcc
DEPCCFLAGS= $(CPPFLAGS)
DEPAS=/usr/src/herman/eclipse/android-ndk-r10e/toolchains/x86-4.8/prebuilt/linux-x86/bin/i686-linux-android-gcc
DEPASFLAGS= $(CPPFLAGS)
YASM=yasm
DEPYASM=yasm
AR=/usr/src/herman/eclipse/android-ndk-r10e/toolchains/x86-4.8/prebuilt/linux-x86/bin/i686-linux-android-ar
ARFLAGS=rc
AR_O=$@
RANLIB=/usr/src/herman/eclipse/android-ndk-r10e/toolchains/x86-4.8/prebuilt/linux-x86/bin/i686-linux-android-ranlib
CP=cp -p
LN_S=ln -s -f
STRIP=/usr/src/herman/eclipse/android-ndk-r10e/toolchains/x86-4.8/prebuilt/linux-x86/bin/i686-linux-android-strip
CPPFLAGS= --sysroot=/usr/src/herman/eclipse/android-ndk-r10e/platforms/android-14/arch-x86 -D_ISOC99_SOURCE -D_FILE_OFFSET_BITS=64 -D_LARGEFILE_SOURCE -DPIC
...
LD_PATH=-L
DLLTOOL=
LDFLAGS=  --sysroot=/usr/src/herman/eclipse/android-ndk-r10e/platforms/android-14/arch-x86 -Wl,--as-needed -Wl,--warn-common -Wl,-rpath-link=libpostproc:libswresample:libswscale:libavfilter:libavdevice:libavformat:libavcodec:libavutil:libavresample
